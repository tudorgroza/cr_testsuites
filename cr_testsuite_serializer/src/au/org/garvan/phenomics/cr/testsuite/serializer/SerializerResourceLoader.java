...
public class SerializerResourceLoader {
	...
	private static TestSuiteLogger<SerializerResourceLoader> logger = (TestSuiteLogger<SerializerResourceLoader>) TestSuiteLogger
	...
	private void loadSerializers(Properties properties) {
		...
		for (Object key : properties.keySet()) {
			...
			if (!propName.startsWith(SerializerUtil.P_SERIALIZER)) {
				continue;
			}
