...
import au.org.garvan.phenomics.cr.testsuite.util.TSFactoryProperties;

public class TestCasesInitializer {

	@SuppressWarnings("unchecked")
	private static TestSuiteLogger<TestCasesInitializer> logger = (TestSuiteLogger<TestCasesInitializer>) TestSuiteLogger
